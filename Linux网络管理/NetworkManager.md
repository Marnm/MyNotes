...
NetworkManager可以通过`networkmanager`包安装，安装后提供一个daemon、一个命令行界面`nmcli`和一个基于curses的界面`nmtui`。

**启用与关闭**

通过`NetworkManager.service`systemd服务启动与关闭
